...
import AddImmunizationData from '../modal/AddImmunizationData';
...
export default function ViewImmunizationData() {
    ...
    const addImmunizationModal = () => {
        dispatch({
            type: "TOGGLE_MODAL",
            payload: {
                isShown: true,
                size: "lg",
                heading: "Add Immunization Data",
                onHide: () => {
                    dispatch({
                        isShown: false,
                        heading: "",
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">View Immunization Data</h1> 
                <button onClick={() => addImmunizationModal()} className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    <AddIcon /> Add Immunization Data
                </button>
            </div>
                                    ...
                                    <TableBody>
                                        {(rowsPerPage > 0
                                            ...
                                            <TableRow key={row.id}>
                                                ...
                                                <TableCell>{row.child?.name}</TableCell>
