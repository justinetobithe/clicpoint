...
export default function ListChildren() {
    ...
    const filteredChildrens = state.childrens.filter((child) =>
        ...
        dateFormat(child.date_of_birth, "mmmm d, yyyy").toLowerCase().includes(searchTerm.toLowerCase()) ||
        child.place_of_birth.toLowerCase().includes(searchTerm.toLowerCase()) ||
        child.relationship.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">List of children</h1>
                <Paper
                    component="form"
                ...
                >
                    <InputBase
                        ...
                        inputProps={{ 'aria-label': 'search child' }}
