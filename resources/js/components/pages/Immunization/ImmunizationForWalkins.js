...
import AddImmunizationForWalkinsModal from '../../modal/AddImmunizationForWalkinsModal';
...
export default function ImmunizationForWalkins() {
    ...
    const addImmunization = () => {
        dispatch({
            ...
            payload: {
                ...
                children: <AddImmunizationForWalkinsModal />
            }
        })
    }
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Immunization (Walk-ins)</h1>
