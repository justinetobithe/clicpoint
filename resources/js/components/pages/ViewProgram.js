...
import AddProgramModal from "../modal/AddProgramModal"
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">View Program</h1>
                <button onClick={addProgram} className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    <AddIcon /> Add Program
                </button>
            </div>
                                    ...
                                    <TableBody>
                                        {(rowsPerPage > 0
                                            ...
                                            <TableRow key={row.id}>
                                                ...
                                                <TableCell>
                                                    {
                                                        row.id == state.programsid ? null : (
                                                            <>
                                                                <Tooltip title="Edit" onClick={() => editProgram(row)}>
