...
import AddOnlineDiagnosisModal from '../modal/AddOnlineDiagnosisModal';
...
export default function DiagnosisForOnline() {
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Diagnosis and Physician's Notes (For Online)</h1>
                {
