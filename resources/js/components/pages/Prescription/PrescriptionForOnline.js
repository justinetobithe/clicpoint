...
import AddOnlinePrescriptionModal from '../../modal/AddOnlinePrescriptionModal';
...
export default function PrescriptionForOnline() {
    ...
    const child_id = new URLSearchParams(location.search).get('child_id');
    ...
    const filteredPrescriptions = state.prescriptions
        ...
        .filter((prescription) => {
            const parentName = prescription.user && prescription.user.name ? prescription.user.name.toLowerCase() : '';
            const childName = prescription.children && prescription.children.name ? prescription.children.name.toLowerCase() : '';
            const doctorName = prescription.doctor && prescription.doctor.user.name ? prescription.doctor.user.name.toLowerCase() : '';
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Prescriptions (Online)</h1>
                <Paper
                    component="form"
